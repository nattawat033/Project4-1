...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <?php
    ...
    $connect = mysqli_connect("localhost","root","","testp");
                        ...
                        $sql = 'SELECT *,COUNT(*) as count_rec FROM `alumni_profile` LEFT JOIN job on alumni_profile.AP_ID = job.AP_ID WHERE fac_name = "ธุรกิจอิเล็กทรอนิกส์" GROUP BY job_citty';
